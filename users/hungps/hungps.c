...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEF] = LAYOUT_hungps(
        ...
        KC_Z,    KC_X,    KC_C,    KC_D,        KC_V,       KC_MUTE,        KC_MPLY,    KC_K,       KC_H,      KC_COMM, KC_DOT,  KC_SCLN,
                                   LT_NAV_ESC,  LT_NUM_SPC, MT_LSFT_TAB,    KC_ENTER,   LT_SYM_BSPC,LT_SYS_DEL
    ),

    [NAV] = LAYOUT_hungps(
        XXXXXXX, RECORD,  PRNSCR,  KC_MSEL,     KC_VOLU,                                KC_HOME,    KC_PGDN, KC_PGUP, KC_END,  XXXXXXX,
        OS_CTRL, OS_ALT,  OS_CMD,  OS_SHFT,     KC_VOLD,                                KC_LEFT,    KC_DOWN, KC_UP,   KC_RGHT, LM_TOGG,
        SPACE_L, SPACE_R, KC_MPRV, KC_MNXT,     KC_MPLY,    _______,        _______,    MS_LEFT,    MS_DOWN, MS_UP,   MS_RGHT, LM_NEXT,
                                   XXXXXXX,     _______,    _______,        MS_BTN1,    MS_BTN2,    MS_BTN3
    ),

    [NUM] = LAYOUT_hungps(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX,                                KC_PLUS,    KC_7,    KC_8,    KC_9,    KC_ASTR,
        OS_CTRL, OS_ALT,  OS_CMD,  OS_SHFT,     XXXXXXX,                                KC_MINS,    KC_4,    KC_5,    KC_6,    KC_SLSH,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX,    _______,        _______,    KC_QUOT,    KC_1,    KC_2,    KC_3,    KC_PERC,
    ...
    [SYM] = LAYOUT_hungps(
        ...
        KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH,     KC_PERC,    _______,        _______,    KC_PEQL,    KC_UNDS, KC_AT,   KC_HASH, KC_BSLS,
                                   _______,     _______,    _______,        _______,    XXXXXXX,    _______
    ),

    [SYS] = LAYOUT_hungps(
        XXXXXXX, XXXXXXX, RM_PREV, RM_NEXT,     RM_TOGG,                                XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, RM_SATU, RM_HUEU, RM_SPDU,     RM_VALU,                                XXXXXXX,    OS_SHFT, OS_CMD,  OS_ALT,  OS_CTRL,
        XXXXXXX, RM_SATD, RM_HUED, RM_SPDD,     RM_VALD,    _______,        _______,    XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
